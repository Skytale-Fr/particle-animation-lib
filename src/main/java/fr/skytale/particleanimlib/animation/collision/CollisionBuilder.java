...
public class CollisionBuilder<T, K extends AAnimationTask> {
     ...
     */
    public void setCollisionPeriod(IVariable<Integer> collisionPeriod) {
     ...
     */
    public void setPotentialCollidingTargetsCollector(Function<K, Collection<T>> collector) {
     ...
     */
    public void addPotentialCollidingTargetsFilter(BiPredicate<T, K> filter) {
     ...
     * @see CollisionProcessor
     */
    public void addCollisionProcessor(CollisionProcessor<T, K> collisionProcessor) {
        this.collisionProcessors.add(collisionProcessor);
    }
