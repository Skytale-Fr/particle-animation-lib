...
public class LineHandsOfClock2PresetExecutor extends AAnimationPresetExecutor<LineBuilder> {

    public LineHandsOfClock2PresetExecutor() {
    ...
    protected void apply(LineBuilder lineBuilder1, JavaPlugin plugin) {
        ...
        lineBuilder2.setRotation(new Vector(0, 0, 1),Math.PI/250);
        ...
        lineBuilder1.setRotation(new Vector(0, 0, 1), Math.PI/500);
    }
}
