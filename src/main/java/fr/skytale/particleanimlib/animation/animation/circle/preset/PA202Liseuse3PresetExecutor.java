...
public class PA202Liseuse3PresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {

    public PA202Liseuse3PresetExecutor() {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        circleBuilder.setPointDefinition(new ParticleTemplate(ParticleEffect.FIREWORKS_SPARK, 0.01f));
    }
}
