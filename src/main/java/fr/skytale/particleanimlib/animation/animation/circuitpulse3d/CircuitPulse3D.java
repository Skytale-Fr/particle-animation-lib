...
public class CircuitPulse3D extends AAnimation {
    ...
    public CircuitPulse3D() {
    }

    @Override
    public CircuitPulse3DTask show() {
        return new CircuitPulse3DTask(this);
    }

    @Override
    public CircuitPulse3D clone() {
        CircuitPulse3D obj = (CircuitPulse3D) super.clone();
