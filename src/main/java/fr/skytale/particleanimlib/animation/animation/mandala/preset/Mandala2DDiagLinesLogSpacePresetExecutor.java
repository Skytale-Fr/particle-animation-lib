...
public class Mandala2DDiagLinesLogSpacePresetExecutor extends AAnimationPresetExecutor<Mandala2DBuilder> {

    public Mandala2DDiagLinesLogSpacePresetExecutor() {
