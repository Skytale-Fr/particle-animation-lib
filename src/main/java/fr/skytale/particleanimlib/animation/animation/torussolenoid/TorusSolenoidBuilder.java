...
import fr.skytale.particleanimlib.animation.animation.torussolenoid.TorusSolenoidTask;
...
public class TorusSolenoidBuilder extends ARotatingAnimationBuilder<TorusSolenoid, TorusSolenoidTask> {
