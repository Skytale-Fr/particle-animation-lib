...
//        Circle p2_2= circleBuilder.getAnimation();
        ...
        //Partie 1
        circleBuilder.applyPreset(AnimationPreset.PA_1_07_PORTAIL_APPARITION_PARTIE_1, plugin);
        circleBuilder.setAnimationEndedCallback(task -> {
            p2_1.show();
//            p2_2.show();
        });
        ...
        Circle vide_1 = circleBuilder.getAnimation();
        ...
        Circle vide_2 = circleBuilder.getAnimation();
