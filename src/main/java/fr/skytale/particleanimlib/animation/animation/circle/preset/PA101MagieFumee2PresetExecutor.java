...
public class PA101MagieFumee2PresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {

    public PA101MagieFumee2PresetExecutor() {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        magie.setAnimationEndedCallback(animationEnding -> fumee.getAnimation().show());
        /*
        COMPOSTER
        CRIT_MAGIC
        END_ROD
        ...
        circleBuilder.setPointDefinition(new ParticleTemplate(ParticleEffect.SPELL_WITCH));
