...
public class PA208BatonEauPresetExecutor extends AAnimationPresetExecutor<HelixBuilder> {
    ...
    protected void apply(HelixBuilder helixBuilder, JavaPlugin plugin) {
        ...
        waveBuilder.setPointDefinition(new ParticleTemplate(Particle.WATER_SPLASH, 0f));
        ...
        sphereBuilder.setPointDefinition(new ParticleTemplate(Particle.END_ROD, 1, 0.8f, new Vector(0.3,0.3,0.3)));
        ...
        helixBuilder.setPointDefinition(new ParticleTemplate(Particle.REDSTONE, 1, 1, new Vector(0, 0, 0), Color.fromRGB(0, 0, 204)));
