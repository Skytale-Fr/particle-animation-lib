...
public class Mandala2DDiagLinesGeomSpaceEvolvingPresetExecutor extends AAnimationPresetExecutor<Mandala2DBuilder> {

    public Mandala2DDiagLinesGeomSpaceEvolvingPresetExecutor() {
