...
public class PA203Attaque2ChargePresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        growingMovingCircleBuilder1.setPointDefinition(new ParticleTemplate(Particle.COMPOSTER, 0f));
        ...
        growingMovingCircleBuilder2.setPointDefinition(new ParticleTemplate(Particle.COMPOSTER, 0f));
