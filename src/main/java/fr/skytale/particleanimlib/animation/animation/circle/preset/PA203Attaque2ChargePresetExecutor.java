...
public class PA203Attaque2ChargePresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {

    public PA203Attaque2ChargePresetExecutor() {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        growingMovingCircleBuilder1.setPointDefinition(new ParticleTemplate(ParticleEffect.COMPOSTER, 0f));
        ...
        growingMovingCircleBuilder2.setPointDefinition(new ParticleTemplate(ParticleEffect.COMPOSTER, 0f));
        ...
        turningPointsCircleBuilder.setPointDefinition(new ParticleTemplate(ParticleEffect.COMPOSTER, 0.01f));
