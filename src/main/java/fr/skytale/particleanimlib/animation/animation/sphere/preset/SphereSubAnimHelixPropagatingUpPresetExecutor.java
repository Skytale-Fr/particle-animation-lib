...
public class SphereSubAnimHelixPropagatingUpPresetExecutor extends AAnimationPresetExecutor<SphereBuilder> {

    public SphereSubAnimHelixPropagatingUpPresetExecutor() {
    ...
    protected void apply(SphereBuilder sphereBuilder, JavaPlugin plugin) {
        ...
        sphereBuilder.setPointDefinition(new SubAnimPointDefinition(
                ...
                new SubAnimOrientationConfig(SubAnimOrientationModifier.PARENT_ANIM_CENTER_ORIENTATION, 0.3, SubAnimOrientationModifier.NO_ADDITIONAL_ORIENTATION)
        ));
