...
public class SubAnimationCircleRotatingPyramidPresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        circleBuilder.setRotation(new Constant<>(new Vector(1, 0, 0)), new DoublePeriodicallyEvolvingVariable(
                Math.PI / 500, Math.PI / 200, 3));
        circleBuilder.setPointDefinition(new SubAnimPointDefinition(pyramidBuilder.getAnimation()));
    }
}
