...
public class SubAnimationCircleRotating3PresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        Circle subCircle = circleBuilder.getAnimation();
        ...
        circleBuilder.setPointDefinition(new SubAnimPointDefinition(subCircle, new SubAnimOrientationConfig(SubAnimOrientationModifier.NO_ADDITIONAL_ORIENTATION)));
    }
}