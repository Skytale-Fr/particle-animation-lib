...
public class PA203Attaque3ChargePresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {

    public PA203Attaque3ChargePresetExecutor() {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        growingMovingCircleBuilder1.setPointDefinition(new ParticleTemplate(ParticleEffect.ELECTRIC_SPARK, 0.01f));
        ...
        growingMovingCircleBuilder2.setPointDefinition(new ParticleTemplate(ParticleEffect.ELECTRIC_SPARK, 0.01f));
        ...
        turningPointsCircleBuilder.setPointDefinition(new ParticleTemplate(ParticleEffect.ELECTRIC_SPARK, 0.01f));
