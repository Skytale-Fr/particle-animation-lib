...
public class PA203Attaque3ChargePresetExecutor extends AAnimationPresetExecutor<CircleBuilder> {
    ...
    protected void apply(CircleBuilder circleBuilder, JavaPlugin plugin) {
        ...
        growingMovingCircleBuilder1.setPointDefinition(new ParticleTemplate(Particle.ELECTRIC_SPARK, 0.01f));
        ...
        growingMovingCircleBuilder2.setPointDefinition(new ParticleTemplate(Particle.ELECTRIC_SPARK, 0.01f));
        ...
        turningPointsCircleBuilder.setPointDefinition(new ParticleTemplate(Particle.ELECTRIC_SPARK, 0.01f));
