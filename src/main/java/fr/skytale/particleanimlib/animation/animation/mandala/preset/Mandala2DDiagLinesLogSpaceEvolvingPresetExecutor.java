...
public class Mandala2DDiagLinesLogSpaceEvolvingPresetExecutor extends AAnimationPresetExecutor<Mandala2DBuilder> {

    public Mandala2DDiagLinesLogSpaceEvolvingPresetExecutor() {
    ...
    protected void apply(Mandala2DBuilder mandala2DBuilder, JavaPlugin plugin) {
        mandala2DBuilder.setPoints(new CurvePointsGenerator<>(
                ...
                new EvolvingRange<>(
                        new LogSpaceRange(0.5, 4, 123, 10),
                        3
                )
        ));
    }
