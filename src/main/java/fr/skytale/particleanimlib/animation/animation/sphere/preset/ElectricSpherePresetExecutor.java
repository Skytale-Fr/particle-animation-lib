...
//        sphereBuilder.setPointDefinition(new ParticleTemplate(Particle.REDSTONE, 1, 0.01f, new Vector(0,0,0), Color.WHITE));
        sphereBuilder.setPointDefinition(new ParticleTemplate(Particle.END_ROD, 1, 0.03f, new Vector(0, 0, 0)));
